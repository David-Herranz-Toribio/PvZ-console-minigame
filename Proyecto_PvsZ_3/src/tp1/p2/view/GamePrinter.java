...
public class GamePrinter {
	...
	protected String getInfo() {
		...
		// TODO fill your code
		buffer.append(Messages.NUMBER_OF_CYCLES).append(MARGIN).append(game.getCycle()).append(NEW_LINE);
		buffer.append(Messages.NUMBER_OF_COINS).append(MARGIN).append(game.getSuncoins()).append(NEW_LINE);
		buffer.append(Messages.REMAINING_ZOMBIES).append(MARGIN).append(game.getRemainingZombies()).append(NEW_LINE);
		buffer.append(Messages.GENERATED_SUNS).append(MARGIN).append(game.getGeneratedSuns()).append(NEW_LINE);
		buffer.append(Messages.CAUGHT_SUNS).append(MARGIN).append(game.getCaughtSuns()).append(NEW_LINE);
		buffer.append(Messages.SCORE).append(MARGIN).append(game.getPuntuation()).append(NEW_LINE);
